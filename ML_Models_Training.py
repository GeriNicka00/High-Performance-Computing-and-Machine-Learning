...
# Choose from [resnet, alexnet, vgg, squeezenet, densenet, inception]
...
image_datasets = {x: datasets.CIFAR100(os.path.join(data_dir, x), transform=data_transforms[x], download=True) for x in ['train', 'val']}
